...
values
  ...
  ('505','shivan'),
  ('303','steve');
insert into record values('cse@ac.in','a','vitamin b');
insert into record values('cse@ac.ip','b','covid');
insert into record values('a1@iiti.ac.in','c','dolo650');
insert into record values('a2@iiti.ac.in','c','vitamin A');
insert into record values('a3@iiti.ac.in','c','vitamin A');
insert into record values('a4@iiti.ac.in','c','pantoprazole');
insert into record values('a5@iiti.ac.in','c','pantoprazole');
insert into record values('a6@iiti.ac.in','c','vitamin D');
insert into record values('a7@iiti.ac.in','c','vitamin D');
insert into record values('a8@iiti.ac.in','c','covid');
insert into record values('a9@iiti.ac.in','d','covid');
